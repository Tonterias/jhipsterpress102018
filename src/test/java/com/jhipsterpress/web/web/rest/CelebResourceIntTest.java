...
public class CelebResourceIntTest {
    ...
    @Test
    @Transactional
    public void getAllCelebsByUmxmIsEqualToSomething() throws Exception {
        // Initialize the database
        ...
        // Get all the celebList where umxm equals to umxmId
        defaultCelebShouldBeFound("umxmId.equals=" + umxmId);

        // Get all the celebList where umxm equals to umxmId + 1
        defaultCelebShouldNotBeFound("umxmId.equals=" + (umxmId + 1));
    }
