...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.jhipsterpress.web.domain.Umxm.class.getName(), jcacheConfiguration);
            cm.createCache(com.jhipsterpress.web.domain.Umxm.class.getName() + ".interests", jcacheConfiguration);
            cm.createCache(com.jhipsterpress.web.domain.Umxm.class.getName() + ".activities", jcacheConfiguration);
            cm.createCache(com.jhipsterpress.web.domain.Umxm.class.getName() + ".celebs", jcacheConfiguration);
            ...
            cm.createCache(com.jhipsterpress.web.domain.Interest.class.getName() + ".umxms", jcacheConfiguration);
            ...
            cm.createCache(com.jhipsterpress.web.domain.Activity.class.getName() + ".umxms", jcacheConfiguration);
            ...
            cm.createCache(com.jhipsterpress.web.domain.Celeb.class.getName() + ".umxms", jcacheConfiguration);
