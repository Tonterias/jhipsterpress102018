...
public interface ActivityRepository extends JpaRepository<Activity, Long>, JpaSpecificationExecutor<Activity> {
    ...
    @Query(value = "select distinct activity from Activity activity left join fetch activity.communities left join fetch activity.umxms",
    ...
    @Query("select activity from Activity activity left join fetch activity.communities left join fetch activity.umxms where activity.id =:id")
